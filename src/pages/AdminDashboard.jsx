...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const token = localStorage.getItem('token'); // You can still send token if available
  
        const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/auth/admin/profile`, {
